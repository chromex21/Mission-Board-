#!/usr/bin/env node
// Legacy copy of the dev JSON server (kept for reference). Use dev-json-server.cjs instead.
...
app.listen(PORT, () => {
  console.log(`(legacy) Dev JSON server listening on http://localhost:${PORT}`);
